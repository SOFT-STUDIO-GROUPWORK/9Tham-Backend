...
public interface IArticleRepository
{
    ...
    Task<ArticlePaginationModel> SearchArticlesPaginated(int page, float perPage, string? search, string? tagId);
    Task<ArticlePaginationModel> SearchReverseArticlesPaginated(int page, float perPage, string? search, string? tagId);
